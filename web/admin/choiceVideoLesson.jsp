<%-- 
    Document   : choiceVideoLesson
    Created on : Mar 13, 2023, 6:46:35 PM
    Author     : Khangnekk
--%>
        ...
        <jsp:include page="navForAdmin.jsp"></jsp:include>
            ...
            <div class="change-quiz">
                ...
                <div class="quiz-label">
                    ...
                    <form action="choiceCourseToAddVideo"  method="GET">
                ...
                <div class="quiz-label">
                    ...
                    <form action="choiceCourseToAddVideo"   method="POST">
            ...
            <div class="change-quiz-bottom">
                <button><a href="./addVideo" style="text-decoration: none; font-size: 1em; color: white">Tiếp tục</a></button>
            </div>
        </div>
