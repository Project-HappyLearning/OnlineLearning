<%-- 
    Document   : choiceContentLession
    Created on : Mar 11, 2023, 7:24:35 PM
    Author     : Acer
--%>
        ...
        <div class="change-quiz">
            ...
            <div class="change-quiz-medium">
                ...
                <div class="quiz-label">
                    ...
                    <form action="ChoiceCourseToAddContent"  method="GET">
                ...
                <div class="quiz-label">
                    ...
                    <form action="ChoiceCourseToAddContent"   method="POST">
            ...
            <div class="change-quiz-bottom">
                <button><a href="./addContent" style="text-decoration: none; font-size: 1em; color: white">Tiếp tục</a></button>
            </div>
        </div>
