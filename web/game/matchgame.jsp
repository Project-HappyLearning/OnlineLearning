...
<body style="background-image: url(../Assets/images/bggame.png)">
    <div class="overlay-text visible">
        <button class="button"> Start</button> 
    </div>
    <div id="timeout-text" class="overlay-text">
        Time out!
        <span class="overlay-text-small">Click to exit</span>
    </div>
...
<script>
    ...
    const gameInfo = new GameInforController(60);
    ...
    function ready() {
        ...
        overlays.forEach(overlay => {
            overlay.addEventListener('click', () => {
                ...
                if (overlay.id === 'timeout-text' || overlay.id === 'winning-text') {
