            ...
            <jsp:include page="nav.jsp"></jsp:include>
                ...
                <div class="content">
                    <div>
                        <div class="banner">
                            <div class="text">                                
                               <h1 style="top: 30%; font-size: 50px; color: black;">HAPPY LEARNING</h1>
                       <h3 style="top:35%; color: black;">Học - Học Nữa - Học Mãi </h3>
                      ...
                      <img style="width: 90%; border-radius: 10px" src="Assets/images/bgk.png" alt="alt"/>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p style="text-align: justify; padding: 0 1em; font-size: 1.25em">
                                       - Ngô Đức Lương<br>
                                        - Đoàn Văn Mạnh<br>
                                        - Phạm Trung Nguyên<br>
                                        - Nguyễn Quang Huy<br>
                                        - Phạm Văn Trường<br><br>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                                ...
                                                <hr
                                                    ...
                                                    style="width: 60px; background-color: #7c4dff; height: 2px"
                                                    />
                                                <p><i class="fas fa-home mr-3"></i> Đại Học FPT, Hà Nội</p>
                                                <p><i class="fas fa-envelope mr-3"></i> luongndhe172441@fpt.edu.vn</p>
                                                <p><i class="fas fa-phone mr-3"></i> 0362593999</p>
                                            </div>
                                            <!-- Grid column -->
                                        </div>
                                        <!-- Grid row -->
