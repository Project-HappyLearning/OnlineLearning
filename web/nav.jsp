...
<div class="nav" style="z-index: 100">
    <div class="nav-bar">
        <ul class="items">
            <li class="item">
                <a href="home.jsp"><img src="Assets/icon/icon (69).png" class="nav-icon"></a>
            </li>
            <!--                    <li class="item">
                <a href="../ranking/ranking.html"><img src="../Assets/icon/icon (44).png"></a>
            </li>-->
            <li class="item">
                <a href="cousrse/classes.jsp"><img src="Assets/icon/icon (71).png" class="nav-icon"></a>
            </li>
            <li class="item">
                <a href="payment/completePayment"><img src="Assets/icon/icon (51).png" class="nav-icon"></a>
            </li>
            <li class="item">
                <a href="ranking/rankingPage"><img src="Assets/icon/icon (43).png" class="nav-icon"></a>
            </li>
