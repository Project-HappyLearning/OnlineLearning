    ...
    <head>
        ...
        <style>
            ...
            .content{
                   width: 70%;
        margin-left: 5%;
          background-image: url(../Assets/images/bgcl.png);
                    ...
                    <div class="container-fluid">
                        ...
                        <c:forEach items="${requestScope.courses}" var="co">
                            <c:if test="${co.course_name eq requestScope.math}">
                                <div class="course-item col-md-4" style=" background-image: url(../Assets/images/toan.jpg);">
                            </c:if>
                            <c:if test="${co.course_name eq requestScope.literature}">
                                <div class="course-item col-md-4" style=" background-image: url(../Assets/images/tv.jpg);">
                            </c:if>
                            <c:if test="${co.course_name eq requestScope.english}">
                                <div class="course-item col-md-4" style=" background-image: url(../Assets/images/ta.jpg);">
                            </c:if>
