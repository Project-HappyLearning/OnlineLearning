    ...
    <body>
        <div id="loading" style="display: none;">
            <img src="https://img.pikbest.com/png-images/20190918/cartoon-snail-loading-loading-gif-animation_2734139.png!bw700" 
                 style="position: fixed; z-index: 10000; top: 50%; left: 50%; width: 200px; height: 200px; background: wheat; border-radius: 15px; transform: translateX(-50%) translateY(-50%)">
        </div>

        <div class="bg" style="margin-bottom: 200px"></div>
        <div class="fillin4">
            <h1 class="signup-heading">Thông tin tài khoản</h1>
            <form id="myForm" action="userprofile" class="signup-form" method="POST">
                <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
                <script>
                    if (typeof jQuery == 'undefined') {
                        document.write('<script src="/path/to/your/local/jquery"><\/script>');
                    }
                </script>
                <script>
                ...
                <!-- gender -->
                <label for="gender" class="signup-label">Giới tính: Nam <input type="radio" value="0" name="gender" checked> | Nữ <input
                        type="radio" value="1" name="gender"> <br></label> <br>
                <br>
            ...
            <p class="signup-already" style="margin: 0">
                <a href="home.jsp" class="cancel signup-submit">Hủy bỏ</a>
            </p>
        </div>
    </body>
</html>
